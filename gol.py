import pygame
#we will use pygame to write and display this code 
import random

pygame.init()

size = (800, 500)  
#the size limit can be increased or decreased accordingly

display = pygame.display.set_mode(size)
pygame.display.set_caption("Its Game of Life")   #GUI Title

clock = pygame.time.Clock()   # creating an object to help track time
done = False

#creating a 2-dimensional table split into a number of rows and columns to hold the cells,and to place cells according to the given conditions
...
# noinspection PyArgumentList - below code is for start(green) and stop(red) button
def draw_buttons():
    global run
